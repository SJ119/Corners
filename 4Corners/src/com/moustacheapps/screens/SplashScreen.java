...
import com.moustacheapps.tweenaccessors.SpriteAccessor;
...
public class SplashScreen implements Screen {
	...
	public SplashScreen(Corners game) {
		this.game = game;
		//AssetLoader.setHighScore();
	}
	...
	public void show() {
		...
		sprite.setSize(desiredWidth, sprite.getHeight() * scale);
